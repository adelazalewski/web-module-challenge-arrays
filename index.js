...
i.e. is31Flavors(originalFlavors) will return TRUE.*/
 ...
 function checkFlavorsCount(arrayProvided){
...
const is31Flavors = checkFlavorsCount(originalFlavors);
console.log(is31Flavors);
// var notA31FlavorsArray = ["a","b","c"];
// const not31Flavors = checkFlavorsCount(notA31FlavorsArray);
...
function addFlavor(a, arrayProvided){
    arrayProvided.unshift(a);
    return arrayProvided;

};

console.log(addFlavor("Rainbow", originalFlavors));
...
function copy(arrayProvided, arrayProvidedCopy){
    var arrayProvidedCopy = [...arrayProvided];
    return arrayProvidedCopy;

};
const copiedOriginal = copy(originalFlavors, [...originalFlavors]);
console.log(copiedOriginal);
